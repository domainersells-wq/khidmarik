...
const INITIAL_SEED_WALLETS: SellerWalletBalance[] = [
  ...
  },
  {
    ...
    defaultAccountNumber: '007890123 44',
    defaultRipNumber: '00799999007890123440',
  },
  {
    sellerId: '23cba611-1b2e-4736-a869-e07686e19084',
    sellerName: 'dino',
    entityType: 'client' as any,
    email: 'hanimnc003@gmail.com',
    phone: '+213 555 00 00 08',
    wilaya: 'Algiers (16)',
    ...
    currency: 'DZD',
    defaultPayoutMethod: 'Algérie Poste (CCP)',
    defaultAccountNumber: '002345678 99',
    defaultRipNumber: '00799999002345678990',
    lastSettlementAt: '2026-09-11 19:00:00',
  },
];

const INITIAL_SEED_TOPUPS: TopUpRequest[] = [
  {
    id: 'topup_dino_000008',
    publicRequestNumber: 'TOP-2026-000008',
    userId: '23cba611-1b2e-4736-a869-e07686e19084',
    userName: 'dino',
    userEmail: 'hanimnc003@gmail.com',
    userPhone: '+213 555 00 00 08',
    accountType: 'client',
    walletId: 'w_dino_8',
    amount: 20000,
    currency: 'DZD',
    ...
    createdAt: '2026-09-11 18:58:00',
    expiresAt: '2026-09-13 18:58:00',
    ...
    senderName: 'dino',
    senderAccount: '002345678 99',
    transferDate: '2026-09-11',
    receiptUrl: '/receipts/ccp_sample_1.jpg',
    userNotes: 'طلب شحن محفظة بمبلغ 20,000 دج عن طريق الحوالة البريدية CCP',
    reviewedBy: 'Admin Finance Desk',
    reviewedAt: '2026-09-11 19:15:00',
    requestedInfoNote: 'يرجى إعادة إرسال رقم العملية البريدية (Code de transaction) أو إرفاق وصل أوضح لإتمام المطابقة البريدية وإيداع الرصيد.',
    requestedInfoAt: '2026-09-11 19:15:00',
    adminNotes: 'بانتظار إعادة إرسال رقم العملية البريدية من المستخدم dino',
  },
  {
    id: 'topup_1',
